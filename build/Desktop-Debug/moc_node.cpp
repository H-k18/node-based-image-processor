...
QT_MOC_LITERAL(1, 5, 15), // "deleteRequested"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 5), // "Node*"
QT_MOC_LITERAL(4, 28, 4), // "node"
QT_MOC_LITERAL(5, 33, 15), // "functionChanged"
QT_MOC_LITERAL(6, 49, 16), // "updateFunctionUI"
QT_MOC_LITERAL(7, 66, 5) // "index"

    },
    "Node\0deleteRequested\0\0Node*\0node\0"
    "functionChanged\0updateFunctionUI\0index"
};
...
void Node::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->deleteRequested((*reinterpret_cast< Node*(*)>(_a[1]))); break;
        case 1: _t->functionChanged(); break;
        case 2: _t->updateFunctionUI((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Node::deleteRequested)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Node::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Node::functionChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Node::deleteRequested(Node * _t1)
{
